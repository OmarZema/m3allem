        ...
        <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <div class="mb-4">
                                ...
                                <label for="password_confirmation" class="sr-only">Pasword again</label>
                                <input type="password" name="password_confirmation" id="pqssword" placeholder="Repeat your password"
